...
@SessionAttributes(value= {"user","tel"}, types=String.class)
...
public class SpringMVCTest {
	...
	public void getUser(@RequestParam(value="id", required=false) Integer id,
		...
		if(id != null) {
			//模拟从数据库中获取对象
			User user = new User(1, "ARMIN", "123456", "armin@163.com", 18);
	...
	public String testSessionAttributes(Map<String , Object> map) {
		User user = new User("ARMIN", "123456", "armin@163.com", 24);
		map.put("user", user);
		map.put("school", "Sichuan University");
		map.put("tel", 9527);
		return SUCCESS;
	}
...
//		return SUCCESS;
	 ...
	 * 	2). 方法处: 提供进一步的细分映射信息。
	 *  	相对于类定义处的 URL。若类定义处未标注 @RequestMapping，则方法处标记的 URL 相对于 WEB 应用的根目录
	 * @return
	 */
